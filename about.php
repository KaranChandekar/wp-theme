...
get_header(); ?>
        ...
        <div class="overflow-x-hidden lg:flex lg:space-x-20">
            <div class="mb-20 lg:mb-0" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
                <div class="md:flex md:mb-6">
                    <img class="mx-auto mb-4 rounded-lg w-60 md:mx-0 md:mb-0" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/team/ayush-gupta.jpg"
                        alt="Ayush Profile">
            ...
            <div data-aos="fade-left" data-aos-delay="1000" data-aos-duration="1000">
                <div class="md:flex md:mb-6">
                    <img class="mx-auto mb-4 rounded-lg w-60 md:mx-0 md:mb-0" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/team/adithya-rathore.jpeg"
                        alt="Ayush Profile">
                    <div class="mb-4 space-y-4 md:mb-0 md:ml-6">
    ...
    <div class="container">
        ...
        <div class="grid-cols-2 gap-8 md:grid lg:grid-cols-3" data-aos="fade-up" data-aos-delay="400"
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career1.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career2.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career3.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career4.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career5.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career6.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career7.svg" alt="">
            ...
            <div
                class=" bg-cover p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career8.svg" alt="">
            ...
            <div
                class="p-8 mb-8 space-y-6 border border-gray-700 rounded-lg md:mb-0 hover:bg-[url('<?php echo esc_url( get_template_directory_uri() ); ?>/images/glow/card-mist-glow.6139fbd9.svg')] cursor-pointer bg-cover ">
                <img class="bg-[#182222] rounded-full p-2" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/careers/career5.svg" alt="">
