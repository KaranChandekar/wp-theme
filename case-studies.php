...
<body class="bg-no-repeat bg-contain bg-bg-img">
    ...
    <div class="container py-0">
        <hr class="mb-20 border border-gray-700">
    </div>

    <!-- Subfooter -->
    <div class="container justify-between mb-12 text-center lg:flex">
        <div class="links-container md:flex-row md:justify-center md:space-y-0 md:space-x-10">
